    ...
    <div className="max-w-6xl mx-auto py-8 px-6">
      ...
      <div className="mb-12">
        <div className="inline-flex items-center justify-center w-16 h-16 rounded-xl bg-graphite mb-6">
          <ClipboardDocumentListIcon className="h-8 w-8 text-platinum" />
        </div>
      ...
      <div className="rounded-2xl bg-platinum border border-grey/20 p-8">
        <p className="text-grey">Add content about Leetcode, coding interview formats, how to practice, and tips for technical interviews.</p>
      </div>
    </div>
  );
}
