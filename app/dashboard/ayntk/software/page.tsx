...
import { CodeBracketSquareIcon, ArrowLeftIcon } from '@heroicons/react/24/outline';
    ...
    <div className="max-w-6xl mx-auto py-8 px-6">
      ...
      <div className="mb-12">
        <div className="inline-flex items-center justify-center w-16 h-16 rounded-xl bg-graphite mb-6">
          <CodeBracketSquareIcon className="h-8 w-8 text-platinum" />
        </div>
        <h1 className={`${lusitana.className} text-4xl md:text-5xl font-bold text-pitch-black mb-4`}>
          All About Software
        </h1>
        <p className="text-xl text-grey">
          Software types, lifecycle, and building for the real world.
        </p>
      </div>
      <div className="rounded-2xl bg-platinum border border-grey/20 p-8">
        <p className="text-grey">Add content about software—applications, systems, tooling, and how software is built and shipped.</p>
      </div>
    </div>
  );
}
