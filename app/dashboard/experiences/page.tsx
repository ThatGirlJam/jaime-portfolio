  ...
  return (
    <div className="max-w-6xl mx-auto py-8 px-6">
      ...
      <div className="mb-12">
        ...
        <p className="text-2xl text-grey font-medium mb-4">NOC SV 2025 - A Year of Entrepreneurship and Adventures</p>
        <p className="text-lg text-grey leading-relaxed mb-6 max-w-3xl">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-8">
          <Image src="/sf_pic_1.gif" width={400} height={300} className="rounded-xl border border-grey/20 shadow-md w-full h-48 object-cover" alt="San Francisco / NOC SV" />
          <Image src="/sf_pic_2.gif" width={400} height={300} className="rounded-xl border border-grey/20 shadow-md w-full h-48 object-cover" alt="San Francisco / NOC SV" />
          <Image src="/sf_pic_3.gif" width={400} height={300} className="rounded-xl border border-grey/20 shadow-md w-full h-48 object-cover md:col-span-1 col-span-2" alt="San Francisco / NOC SV" />
        </div>
        ...
        <div className="space-y-8">
          <div className="rounded-2xl bg-platinum border border-grey/20 p-8 hover:shadow-lg transition-all">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
              <Image src="/sf_pic_4.gif" width={400} height={300} className="rounded-xl border border-grey/20 shadow-md w-full h-48 object-cover" alt="NOC SV / Workstream" />
              <Image src="/sf_pic_5.gif" width={400} height={300} className="rounded-xl border border-grey/20 shadow-md w-full h-48 object-cover" alt="NOC SV / Workstream" />
              <Image src="/sf_pic_6.gif" width={400} height={300} className="rounded-xl border border-grey/20 shadow-md w-full h-48 object-cover" alt="NOC SV / Workstream" />
            </div>
          </div>
          ...
          <div className="rounded-2xl bg-platinum border border-grey/20 p-8 hover:shadow-lg transition-all">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
              <Image src="/sf_pic_7.gif" width={400} height={300} className="rounded-xl border border-grey/20 shadow-md w-full h-48 object-cover" alt="Stanford / NOC SV" />
              <Image src="/sf_pic_8.jpeg" width={400} height={300} className="rounded-xl border border-grey/20 shadow-md w-full h-48 object-cover" alt="Stanford / NOC SV" />
              <Image src="/sf_pic_9.gif" width={400} height={300} className="rounded-xl border border-grey/20 shadow-md w-full h-48 object-cover" alt="Stanford / NOC SV" />
            </div>
          </div>
          ...
          <div className="rounded-2xl bg-platinum border border-grey/20 p-8 hover:shadow-lg transition-all">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-6">
              <Image src="/sf_pic_10.jpeg" width={400} height={300} className="rounded-xl border border-grey/20 shadow-md w-full h-48 object-cover" alt="Travelling / NOC SV" />
              <Image src="/sf_pic_11.jpeg" width={400} height={300} className="rounded-xl border border-grey/20 shadow-md w-full h-48 object-cover" alt="Travelling / NOC SV" />
              <Image src="/sf_pic_12.jpeg" width={400} height={300} className="rounded-xl border border-grey/20 shadow-md w-full h-48 object-cover" alt="Travelling / NOC SV" />
              <Image src="/sf_pic_13.jpeg" width={400} height={300} className="rounded-xl border border-grey/20 shadow-md w-full h-48 object-cover" alt="Travelling / NOC SV" />
            </div>
          </div>

          {/* Learning points from the year */}
          <div className="rounded-2xl bg-graphite border border-grey/20 p-8 hover:shadow-lg transition-all">
            <h3 className="text-2xl font-semibold text-platinum mb-6">Learning points from the year</h3>
            <ul className="space-y-4 text-platinum/95 text-lg leading-relaxed list-none">
