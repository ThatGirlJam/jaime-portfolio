  ...
  return (
    <div>
      ...
      <p>
        ...
        We were tasked with implementing a personal project from scratch. Hence,
        my partner and I created a travel-planning web application that earned
        the highest level of achievement, 'Artemis'.
      </p>
      <br />
      <p>
