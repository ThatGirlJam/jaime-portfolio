  ...
  return (
    <div>
      ...
      <p>
        ...
        Hence, my partner and I created a travel-planning web application that earned the highest level of achievement, 'Artemis'. <br/> <br/>
        Roamio may be accessed at roamio.vercel.app. However, as it makes use of free pricing plans, it may not be fully functioning as of now.
      </p>
      <br/>
      <p>Tech used: Next.js, Prisma, Planetscale, MySQL, Tailwind, Mantine UI</p>
      <br/>
