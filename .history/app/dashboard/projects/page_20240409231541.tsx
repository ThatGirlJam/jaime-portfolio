...
export default function Page() {
  return (
    <div>
      ...
      <p>
        Roamio is a web app that aims to improve the travelling experiences of
        all, by autogenerating your packing list and giving itinerary
        suggestions for your travels. To find out more about its implementation,
        you may see{' '}
        <a
      ...
      <p>
        ...
        . However, it may not be fully functional currently due to free pricing
        plans.
      </p>
      <br />

      <p>
        Tech Stack: Next.js, Prisma, Planetscale, MySQL, Tailwind, Mantine UI
      </p>
      <br />
