...
export default function Page() {
  ...
  return (
    <div className="text-center"> {/* Apply text-center class to center-align all content */}
      ...
      <ul>
        <li>Github: <a href="https://github.com/ThatGirlJam" target="blank" className="text-blue-500">link to my GitHub</a> </li>
        <li>Email: <a className="text-blue-500">jaimengjm@gmail.com</a> </li>
        <li>LinkedIn: </li>
      </ul>
    </div>
  );
