    ...
    <div className="text-center"> {/* Apply text-center class to center-align all content */}
      ...
      <div className="max-w-2xl mx-auto"> {/* Apply mx-auto class to horizontally center the div */}
        <p className="text-[20px]">
          ...
          I have a keen interest in learning more about AI and Machine Learning, Software Development and CyberSecurity. As I'm still exploring my passions, I'm 
          always eager to learn anything outside my comfort zone. 
        </p>
      </div>
    </div>
  );
